...
picArray.forEach((articleInfo) => {

  let articleElement = document.createElement("article");
  articleElement.classList.add("card");

  let headerElement = document.createElement("h2");
  headerElement.innerHTML = articleInfo.title;

  let figureElement = document.createElement("figure");

  let imgElement = document.createElement("img");
  imgElement.src = articleInfo.image.medium;
  imgElement.alt = articleInfo.title;

  let figureCaption = document.createElement("figcaption");
  figureCaption.innerHTML = articleInfo.caption;

  let pElement = document.createElement("p");
  pElement.innerHTML = articleInfo.description;
